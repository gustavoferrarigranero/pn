...
<?php echo $this->Form->create('TbOlheiro'); ?>
	<fieldset>
		<legend><?php echo __('Editar Olheiro'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Deletar'), array('action' => 'delete', $this->Form->value('TbOlheiro.id_olheiro')), array(), __('Você quer deletar # %s?', $this->Form->value('TbOlheiro.id_olheiro'))); ?></li>
