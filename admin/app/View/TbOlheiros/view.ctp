...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Editar Olheiro'), array('action' => 'edit', $tbOlheiro['TbOlheiro']['id_olheiro'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Deletar Olheiro'), array('action' => 'delete', $tbOlheiro['TbOlheiro']['id_olheiro']), array(), __('Você quer deletar # %s?', $tbOlheiro['TbOlheiro']['id_olheiro'])); ?> </li>
